...
<div class="flex tabs justify-center gap-1">
...
<div class="mt-8">
	{#if data}
		...
		{:else if $page === 8}
		    <OverallTable data={[...tableTennisData,...badmintonData,...netballData,...bowlingData,...carromData,...footballData,...esportData, ...sprintData, ...medivestGotTalentData]} />
		{:else if $page === 9}
